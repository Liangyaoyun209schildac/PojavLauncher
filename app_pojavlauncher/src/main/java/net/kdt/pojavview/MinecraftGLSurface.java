...
import net.kdt.pojavview.customcontrols.gamepad.Gamepad;
...
import net.kdt.pojavview.utils.MathUtils;
...
public class MinecraftGLSurface extends View implements GrabListener {
    ...
    public int handleGuiBar(int x, int y) {
        ...
        return HOTBAR_KEYS[(int) net.kdt.pojavview.utils.MathUtils.map(x, barX, barX + barWidth, 0, 9)];
    }
