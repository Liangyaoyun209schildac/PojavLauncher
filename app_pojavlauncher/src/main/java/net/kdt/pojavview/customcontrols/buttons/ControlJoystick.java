package net.kdt.pojavview.customcontrols.buttons;

import static net.kdt.pojavview.customcontrols.gamepad.GamepadJoystick.DIRECTION_EAST;
import static net.kdt.pojavview.customcontrols.gamepad.GamepadJoystick.DIRECTION_NONE;
import static net.kdt.pojavview.customcontrols.gamepad.GamepadJoystick.DIRECTION_NORTH;
import static net.kdt.pojavview.customcontrols.gamepad.GamepadJoystick.DIRECTION_NORTH_EAST;
import static net.kdt.pojavview.customcontrols.gamepad.GamepadJoystick.DIRECTION_NORTH_WEST;
import static net.kdt.pojavview.customcontrols.gamepad.GamepadJoystick.DIRECTION_SOUTH;
import static net.kdt.pojavview.customcontrols.gamepad.GamepadJoystick.DIRECTION_SOUTH_EAST;
import static net.kdt.pojavview.customcontrols.gamepad.GamepadJoystick.DIRECTION_SOUTH_WEST;
import static net.kdt.pojavview.customcontrols.gamepad.GamepadJoystick.DIRECTION_WEST;

import android.annotation.SuppressLint;
import android.view.View;

import net.kdt.pojavview.LwjglGlfwKeycode;
import net.kdt.pojavview.Tools;
import net.kdt.pojavview.customcontrols.ControlData;
import net.kdt.pojavview.customcontrols.ControlJoystickData;
import net.kdt.pojavview.customcontrols.ControlLayout;
import net.kdt.pojavview.customcontrols.gamepad.GamepadJoystick;
import net.kdt.pojavview.customcontrols.handleview.EditControlPopup;
